...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:@localhost/SSPO?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://root:@localhost/SSPO?new_link=true');
}
...
$civicrm_root = 'Z:\home\localhost\www\joomla\administrator\components\com_civicrm\civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'Z:\home\localhost\www\joomla\media\civicrm\templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://127.0.0.1/joomla/administrator/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '62b0b8e90bcf60e910ddbb64e4a095ef');
}
...
// define( 'CIVICRM_MAIL_LOG', 'Z:\home\localhost\www\joomla\media\civicrm\templates_c/mail.log');
// }
