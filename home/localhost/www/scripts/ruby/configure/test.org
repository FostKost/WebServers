...
create vlan 79 tag 9,10
config vlan 79 add tagged 9,10
create vlan 101 tag 101
config vlan 101 add tagged 9,10
create vlan 201 tag 201
config vlan 201 add tagged 9,10
create vlan 901 tag 901
config vlan 901 add tagged 9,10
create vlan 3101 tag 3101
config vlan 3101 add tagged 9,10
create vlan 4002 tag 4002
config vlan 4002 add tagged 9,10
create vlan 4003 tag 4003
config vlan 4003 add tagged 9,10
config vlan 4003 add untagged 0,1,2,3,4,5,6,7,8
disable qinq
disable gvrp
...
config ipif System ipaddress 10.52.8.66/255.255.255.0 vlan 101 state enable
disable autoconfig
...
config port_security ports 0,1,2,3,4,5,6,7,8 admin_state enable max_learning_addr 2 lock_address_mode deleteontimeout
config port_security ports 9,10 admin_state disable max_learning_addr 1 lock_address_mode deleteontimeout

# STORM

config traffic control 0,1,2,3,4,5,6,7,8 broadcast enable multicast enable unicast disable action drop threshold 128 countdown 0 time_interval 5
...
config loopdetect ports 0,1,2,3,4,5,6,7,8 state enable
...
config lldp ports 9,10 mgt_addr ipv4 10.52.8.66 enable
config lldp ports 0,1,2,3,4,5,6,7,8 admin_status rx_only
