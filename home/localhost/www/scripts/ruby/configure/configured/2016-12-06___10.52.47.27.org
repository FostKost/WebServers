...
ip access-list extended trusted-hosts
  permit ip 10.52.47.0 0.0.0.255 any-destination
  permit ip host-source 79.140.16.7 any-destination
  permit ip host-source 79.140.16.8 any-destination
  permit ip host-source 81.30.199.70 any-destination
...
policy-map 1
 ...
 exit
!
vacl ip access-group permit-and-block-fiz in traffic-statistic vlan 4055
vacl ip access-group permit-and-block in traffic-statistic vlan 3128;4054
!
...
Interface ethernet 1/27
 ...
 service-policy input 1
 lldp management-address tlv 10.52.47.27
 switchport mode trunk
 switchport trunk allowed vlan 77;128;228;928;3128;4054;4055 
!
...
!
interface Vlan128
 ip address 10.52.47.27 255.255.255.192
!
ip default-gateway 10.52.47.1
!
sntp polltime 600
