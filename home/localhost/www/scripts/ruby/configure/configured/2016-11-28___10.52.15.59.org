...
create vlan 78 tag 9,10
config vlan 78 add tagged 9,10
create vlan 104 tag 104
config vlan 104 add tagged 9,10
create vlan 204 tag 204
config vlan 204 add tagged 9,10
create vlan 904 tag 904
config vlan 904 add tagged 9,10
create vlan 3104 tag 3104
config vlan 3104 add tagged 9,10
create vlan 4008 tag 4008
config vlan 4008 add tagged 9,10
create vlan 4009 tag 4009
config vlan 4009 add tagged 9,10
config vlan 4009 add untagged 1,2,3,4,5,6,7,8,
disable qinq
disable gvrp
...
config ipif System ipaddress 10.52.15.59/255.255.255.192 vlan 104 state enable
disable autoconfig
config autoconfig timeout 50

# ROUTE

create iproute default 10.52.15.1 1

# PORT_SECURITY

config port_security system max_learning_addr no_limit
disable port_security trap_log
config port_security ports 1,2,3,4,5,6,7,8, admin_state enable max_learning_addr 2 lock_address_mode deleteontimeout
config port_security ports 9,10 admin_state disable max_learning_addr 1 lock_address_mode deleteontimeout

# STORM

config traffic control 1,2,3,4,5,6,7,8, broadcast enable multicast enable unicast disable action drop threshold 128 countdown 0 time_interval 5
config traffic control 9,10 broadcast enable multicast enable unicast disable action drop threshold 4096 countdown 0 time_interval 5
...
config loopdetect ports 1,2,3,4,5,6,7,8, state enable
...
create trusted_host network 10.52.15.0/24
...
config bandwidth_control 9,10 rx_rate no_limit tx_rate no_limit
...
config lldp ports 9,10 mgt_addr ipv4 10.52.15.59 enable
config lldp ports 1,2,3,4,5,6,7,8, admin_status rx_only
...
config access_profile profile_id 2 add access_id 45 ip vlan_id 4009 tcp dst_port 42 port all deny
config access_profile profile_id 2 add access_id 50 ip vlan_id 4009 tcp dst_port 135 port all deny
config access_profile profile_id 2 add access_id 55 ip vlan_id 4009 tcp dst_port 136 port all deny
config access_profile profile_id 2 add access_id 60 ip vlan_id 4009 tcp dst_port 137 port all deny
config access_profile profile_id 2 add access_id 65 ip vlan_id 4009 tcp dst_port 138 port all deny
config access_profile profile_id 2 add access_id 70 ip vlan_id 4009 tcp dst_port 139 port all deny
config access_profile profile_id 2 add access_id 75 ip vlan_id 4009 tcp dst_port 445 port all deny
config access_profile profile_id 2 add access_id 80 ip vlan_id 4009 tcp dst_port 1900 port all deny
...
config access_profile profile_id 3 add access_id 50 ip vlan_id 4009 udp dst_port 42 port all deny
config access_profile profile_id 3 add access_id 55 ip vlan_id 4009 udp dst_port 135 port all deny
config access_profile profile_id 3 add access_id 60 ip vlan_id 4009 udp dst_port 136 port all deny
config access_profile profile_id 3 add access_id 65 ip vlan_id 4009 udp dst_port 137 port all deny
config access_profile profile_id 3 add access_id 70 ip vlan_id 4009 udp dst_port 138 port all deny
config access_profile profile_id 3 add access_id 75 ip vlan_id 4009 udp dst_port 139 port all deny
config access_profile profile_id 3 add access_id 80 ip vlan_id 4009 udp dst_port 1900 port all deny
config access_profile profile_id 3 add access_id 85 ip vlan_id 4009 udp dst_port 5355 port all deny
config access_profile profile_id 3 add access_id 90 ip vlan_id 4009 destination_ip 224.0.0.0 mask 255.0.0.0 port all deny
...
config access_profile profile_id 3 add access_id 200 ip vlan_id 4008 udp dst_port 68 port all deny
config access_profile profile_id 3 add access_id 205 ip vlan_id 4009 udp dst_port 68 port all deny
config access_profile profile_id 3 add access_id 210 ip vlan_id 3104 udp dst_port 68 port all deny
...
config access_profile profile_id 4 add access_id 20 ethernet vlan_id 3104 port all deny
config access_profile profile_id 4 add access_id 30 ethernet vlan_id 4008 port all deny
config access_profile profile_id 3 add access_id auto_assign ip source_ip 92.50.143.178 mask 255.255.255.255 port all permit priority 7 replace_priority 
config access_profile profile_id 3 add access_id auto_assign ip destination_ip 92.50.143.178 mask 255.255.255.255 port all permit priority 7 replace_priority 
