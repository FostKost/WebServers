...
config ipif System vlan 101 ipaddress 10.52.8.35/255.255.255.192 state enable clear_description
enable telnet 23
disable web
disable autoconfig
...
config lldp ports 23,24 mgt_addr ipv4 10.52.8.35 enable
