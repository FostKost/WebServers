...
config ipif System vlan 166 ipaddress <ip>/<mask> state enable clear_description
enable telnet 23
enable web 80
disable autoconfig
...
config traffic_segmentation 1-10 forward_list <up>
config traffic_segmentation <up> forward_list 1-10
