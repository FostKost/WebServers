...
config vlan 121 add tagged 9-10
create vlan 221 tag 221
config vlan 221 add tagged 9-10
create vlan 921 tag 921
config vlan 921 add tagged 9-10
create vlan 3121 tag 3121
config vlan 3121 add tagged 9-10
create vlan 4042 tag 4042
config vlan 4042 add tagged 9-10
config vlan 4042 add untagged 1-2
create vlan 4043 tag 4043
config vlan 4043 add tagged 9-10
config vlan 4043 add untagged 3-8
disable gvrp
disable vlan_trunk
...
config ipif System ipaddress 10.52.2.78/26 vlan 121 state enable
...
create iproute default 10.52.2.65 1
...
create trusted_host network 10.52.2.0/24
...
config snmp system_location Kashirina 4 p2
...
config lldp ports 9-10 mgt_addr ipv4 10.52.2.78 enable
...
config access_profile profile_id 2 add access_id 5 ip vlan 4043 tcp dst_port 42  port 1-10 deny                                                 
config access_profile profile_id 2 add access_id 10 ip vlan 4043 tcp dst_port 135  port 1-10 deny                                               
config access_profile profile_id 2 add access_id 15 ip vlan 4043 tcp dst_port 136  port 1-10 deny                                               
config access_profile profile_id 2 add access_id 20 ip vlan 4043 tcp dst_port 137  port 1-10 deny                                               
config access_profile profile_id 2 add access_id 25 ip vlan 4043 tcp dst_port 138  port 1-10 deny                                               
config access_profile profile_id 2 add access_id 30 ip vlan 4043 tcp dst_port 139  port 1-10 deny                                               
config access_profile profile_id 2 add access_id 35 ip vlan 4043 tcp dst_port 445  port 1-10 deny                                               
config access_profile profile_id 2 add access_id 40 ip vlan 4043 tcp dst_port 1900  port 1-10 deny                                              
create access_profile profile_id 3 ip vlan udp dst_port_mask 0xFFFF                                                                             
config access_profile profile_id 3 add access_id 45 ip vlan 4043 udp dst_port 42  port 1-10 deny                                                
config access_profile profile_id 3 add access_id 50 ip vlan 4043 udp dst_port 135  port 1-10 deny                                               
config access_profile profile_id 3 add access_id 55 ip vlan 4043 udp dst_port 136  port 1-10 deny                                               
config access_profile profile_id 3 add access_id 60 ip vlan 4043 udp dst_port 137  port 1-10 deny                                               
config access_profile profile_id 3 add access_id 65 ip vlan 4043 udp dst_port 138  port 1-10 deny                                               
config access_profile profile_id 3 add access_id 70 ip vlan 4043 udp dst_port 139  port 1-10 deny                                               
config access_profile profile_id 3 add access_id 75 ip vlan 4043 udp dst_port 1900  port 1-10 deny                                              
config access_profile profile_id 3 add access_id 80 ip vlan 4043 udp dst_port 5355  port 1-10 deny  
...
config access_profile profile_id 4 add access_id 5 ip vlan 4043 destination_ip 224.0.0.0  port 1-10 deny                                        
...
config access_profile profile_id 16 add access_id 5 ip vlan 4042 udp dst_port 68  port 1-10 deny                                                
config access_profile profile_id 16 add access_id 10 ip vlan 4043 udp dst_port 68  port 1-10 deny                                               
config access_profile profile_id 16 add access_id 15 ip vlan 3121 udp dst_port 68  port 1-10 deny                                               
...
config access_profile profile_id 17 add access_id 20 ethernet vlan 3121  port 1-10 deny                                                         
config access_profile profile_id 17 add access_id 25 ethernet vlan 4042  port 1-10 deny           
config access_profile profile_id 3 add access_id auto_assign ip source_ip 92.50.143.178 mask 255.255.255.255 port all permit priority 7 replace_priority 
config access_profile profile_id 3 add access_id auto_assign ip destination_ip 92.50.143.178 mask 255.255.255.255 port all permit priority 7 replace_priority 
