...
config vlan 79 add tagged 25-26
create vlan 100 tag 100
config vlan 100 add tagged 25-26
create vlan 200 tag 200
config vlan 200 add tagged 25-26
create vlan 900 tag 900
config vlan 900 add tagged 25-26
create vlan 3100 tag 3100
config vlan 3100 add tagged 25-26
create vlan 4000 tag 4000
config vlan 4000 add tagged 25-26
create vlan 4001 tag 4001
config vlan 4001 add tagged 25-26
config vlan 4001 add untagged 1-24
disable vlan_trunk

# IP

config ipif System vlan 100 ipaddress 10.52.7.105/26 state enable clear_description
enable telnet 23
disable web
disable autoconfig
...
create iproute default 10.52.7.65 1

# STORM

config traffic control 1-24 broadcast enable multicast enable action drop threshold 128 time_interval 5 countdown 5
config traffic control 25-26 broadcast enable multicast enable action drop threshold 4096 time_interval 5 countdown 5
...
config traffic_segmentation 1-25 forward_list 25-26
...
config snmp system_name DRGS374002656
config snmp system_location Turkestanskaya 29 p5
...
config stp ports 1-24 cost auto priority 128 edge false p2p auto state enabled fbpdu enabled restricted_role false restricted_tcn false
...
config lldp ports 25-26 mgt_addr ipv4 10.52.7.105 enable
...
config address_binding ip_mac ports 1-24 state disable allow_zeroip disable
