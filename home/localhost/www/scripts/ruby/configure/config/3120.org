...
config vlan 76 add tagged 23-24
create vlan 155 tag 155
config vlan 155 add tagged 23-24
create vlan 255 tag 255
config vlan 255 add tagged 23-24
create vlan 955 tag 955
config vlan 955 add tagged 23-24
create vlan 3155 tag 3155
config vlan 3155 add tagged 23-24
create vlan 3986 tag 3986
config vlan 3986 add tagged 23-24
create vlan 3987 tag 3987
config vlan 3987 add tagged 23-24
config vlan 3987 add untagged 1-22
disable gvrp
...
config ipif System ipaddress 10.52.70.25/26 vlan 155
config ipif System proxy_arp disable local disable
disable autoconfig 

# ROUTE

create iproute default 10.52.70.1 1 primary
...
config traffic control 1-22 broadcast enable multicast enable unicast disable action drop threshold 128 countdown 5 time_interval 5 
...
config bandwidth_control 1-22 rx_rate 102400 tx_rate 102400
...
create trusted_host network 10.52.70.0/24 snmp telnet ssh http https ping
...
config snmp system_location Drugby 5 p3 
...
config lldp ports 23-24 mgt_addr ipv4 10.52.70.25 enable
...
config access_profile profile_id 2 add access_id 45 ip vlan_id 3987 tcp dst_port 42 port all deny
config access_profile profile_id 2 add access_id 50 ip vlan_id 3987 tcp dst_port 135 port all deny
config access_profile profile_id 2 add access_id 55 ip vlan_id 3987 tcp dst_port 136 port all deny
config access_profile profile_id 2 add access_id 60 ip vlan_id 3987 tcp dst_port 137 port all deny
config access_profile profile_id 2 add access_id 65 ip vlan_id 3987 tcp dst_port 138 port all deny
config access_profile profile_id 2 add access_id 70 ip vlan_id 3987 tcp dst_port 139 port all deny
config access_profile profile_id 2 add access_id 75 ip vlan_id 3987 tcp dst_port 445 port all deny
config access_profile profile_id 2 add access_id 80 ip vlan_id 3987 tcp dst_port 1900 port all deny
...
config access_profile profile_id 3 add access_id 50 ip vlan_id 3987 udp dst_port 42 port all deny
config access_profile profile_id 3 add access_id 55 ip vlan_id 3987 udp dst_port 135 port all deny
config access_profile profile_id 3 add access_id 60 ip vlan_id 3987 udp dst_port 136 port all deny
config access_profile profile_id 3 add access_id 65 ip vlan_id 3987 udp dst_port 137 port all deny
config access_profile profile_id 3 add access_id 70 ip vlan_id 3987 udp dst_port 138 port all deny
config access_profile profile_id 3 add access_id 75 ip vlan_id 3987 udp dst_port 139 port all deny
config access_profile profile_id 3 add access_id 80 ip vlan_id 3987 udp dst_port 1900 port all deny
config access_profile profile_id 3 add access_id 85 ip vlan_id 3987 udp dst_port 5355 port all deny
config access_profile profile_id 3 add access_id 90 ip vlan_id 3987 destination_ip 224.0.0.0 mask 255.0.0.0 port all deny
...
config access_profile profile_id 3 add access_id 200 ip vlan_id 3986 udp dst_port 68 port all deny
config access_profile profile_id 3 add access_id 205 ip vlan_id 3987 udp dst_port 68 port all deny
config access_profile profile_id 3 add access_id 210 ip vlan_id 3155 udp dst_port 68 port all deny
...
config access_profile profile_id 4 add access_id 20 ethernet vlan_id 3155 port all deny
config access_profile profile_id 4 add access_id 30 ethernet vlan_id 3986 port all deny
config access_profile profile_id 3 add access_id auto_assign ip source_ip 92.50.143.178 mask 255.255.255.255 port all permit priority 7 replace_priority 
config access_profile profile_id 3 add access_id auto_assign ip destination_ip 92.50.143.178 mask 255.255.255.255 port all permit priority 7 replace_priority 
