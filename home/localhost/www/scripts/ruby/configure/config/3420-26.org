...
config vlan default add tagged 23-26
config vlan default advertisement disable
create vlan 163 tag 163
config vlan 163 add tagged 1-13,23-26 advertisement disable
create vlan 263 tag 263
config vlan 263 add tagged 1-13,23-26 advertisement disable
create vlan 963 tag 963
config vlan 963 add tagged 1-13,23-26 advertisement disable
create vlan 3974 tag 3974
config vlan 3974 add tagged 1-13,23-26 advertisement disable
create vlan 3975 tag 3975
config vlan 3975 add tagged 1-13,23-26
disable gvrp
...
config ipif System ipaddress 10.52.102.66/24 vlan 163
...
create iproute default 10.52.102.1 1 primary
...
config traffic control 23-26 broadcast enable multicast enable unicast disable action drop threshold 4096 countdown 5 time_interval 5 
...
config traffic_segmentation 1-22 forward_list 23-26
config traffic_segmentation 23-26 forward_list all
...
config loopdetect ports 23-26 state disable
config loopdetect trap none

# MANAGEMENT

create trusted_host network 10.52.102.0/24 snmp telnet ssh http https ping
...
enable snmp
config snmp system_name (S5022)
config snmp system_location Proletarskaya 314 p7
...
config stp ports 23-26 externalCost auto  edge false p2p auto state enable restricted_role false restricted_tcn false
disable stp
...
config lldp ports 1-13,23-26 admin_status tx_and_rx
config lldp ports 14-22 admin_status rx_only
config lldp ports 1-26 mgt_addr ipv4 10.52.102.66 enable
...
config link_aggregation group_id 2 master_port 25 ports 25-26 state enable
config lacp_port 1-22 mode passive
config lacp_port 23-26 mode active
...
config mac_based_access_control ports  1-26 max_users 1024
