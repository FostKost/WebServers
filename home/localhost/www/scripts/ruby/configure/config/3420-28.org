...
create vlan 164 tag 164
config vlan 164 add tagged 1-15,22-24 advertisement disable
create vlan 264 tag 264
config vlan 264 add tagged 1-15,22-24 advertisement disable
create vlan 964 tag 964
config vlan 964 add tagged 1-15,22-24 advertisement disable
create vlan 4084 tag 4084
config vlan 4084 add tagged 1-15,22-24 advertisement disable
create vlan 4085 tag 4085
config vlan 4085 add tagged 1-15,22-24 advertisement disable
disable gvrp
...
config ipif System ipaddress 10.52.101.2/24 vlan 164
...
config traffic control 1-21 broadcast enable multicast enable unicast disable action drop threshold 128 countdown 5 time_interval 5
config traffic control 22-23 broadcast enable multicast enable unicast disable action drop threshold 2048 countdown 5 time_interval 5 
...
config traffic_segmentation 1-21 forward_list 22-24
config traffic_segmentation 22-24 forward_list all
...
config port_security ports 16-21 admin_state enable max_learning_addr 1 lock_address_mode deleteontimeout
config port_security ports 1-15,22-24 admin_state disable max_learning_addr 1 lock_address_mode deleteontimeout
...
config loopdetect ports 16-21 state enable
config loopdetect ports 1-15,22-24 state disable
config loopdetect trap none

# MANAGEMENT

create trusted_host network 10.52.101.0/24 snmp telnet ssh http https ping
...
config snmp system_location Tereshkovoy 251/1 p1
...
config lldp ports 1-15,22-24 admin_status tx_and_rx
config lldp ports 16-21 admin_status rx_only
