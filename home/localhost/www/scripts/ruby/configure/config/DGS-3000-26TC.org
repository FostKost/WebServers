...
config vlan 132 add tagged <system port>
create vlan 232 tag 232
config vlan 232 add tagged <system port>
create vlan 932 tag 932
config vlan 932 add tagged <system port>
...
config vlan <vpn fiz vlan> add untagged <client port> advertisement disable
disable gvrp
disable vlan_trunk
...
config bandwidth_control <system port> tx_rate no_limit rx_rate no_limit
...
config 802.1p default_priority <client port> 1
config 802.1p default_priority <system port> 0
...
config lldp ports <system port> admin_status rx_only
#####################################################################################################################
