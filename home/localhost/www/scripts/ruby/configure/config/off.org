...
create vlan 4060 tag 4060
config vlan 4060 add tagged 24-26
config vlan 4060 add untagged 1-23
disable gvrp
disable vlan_trunk

# IP

config ipif System ipaddress 192.168.160.59/23 vlan 4060 state enable
...
create iproute default 192.168.161.254 1

# STORM

config traffic control 24-26 broadcast enable multicast enable unicast disable action drop threshold 4096
config traffic control 1-23 broadcast enable multicast enable unicast disable action drop threshold 128
...
config bandwidth_control 1-26 tx_rate no_limit rx_rate no_limit
...
config loopdetect ports 24-26 state disable
...
config snmp system_location Aksakova 17 Cokolniy etazh 3
...
config lldp ports 24-26 admin_status tx_and_rx
config lldp ports 24-26 mgt_addr ipv4 192.168.160.59 enable
config lldp ports 1-23 admin_status rx_only
#####################################################################################################################
