...
config vlan 77 add tagged 25-28
create vlan 115 tag 115
config vlan 115 add tagged 25-28
create vlan 215 tag 215
config vlan 215 add tagged 25-28
create vlan 915 tag 915
config vlan 915 add tagged 25-28
create vlan 3115 tag 3115
config vlan 3115 add tagged 25-28
create vlan 4030 tag 4030
config vlan 4030 add tagged 25-28
create vlan 4031 tag 4031
config vlan 4031 add tagged 25-28
config vlan 4031 add untagged 1-24
...
config ipif System vlan 115 ipaddress 10.52.92.62/26 state enable
...
config traffic control 1-24 broadcast enable multicast enable unicast disable action drop threshold 128 countdown 5 time_interval 5
config traffic control 25-28 broadcast enable multicast enable unicast disable action drop threshold 4096 countdown 5 time_interval 5
...
config traffic_segmentation 1-28 forward_list 28
...
config lldp ports 25-28 mgt_addr ipv4 10.52.92.62 enable
...
config access_profile profile_id 2 add access_id 45 ip vlan_id 4031 tcp dst_port 42 port all deny
config access_profile profile_id 2 add access_id 50 ip vlan_id 4031 tcp dst_port 135 port all deny
config access_profile profile_id 2 add access_id 55 ip vlan_id 4031 tcp dst_port 136 port all deny
config access_profile profile_id 2 add access_id 60 ip vlan_id 4031 tcp dst_port 137 port all deny
config access_profile profile_id 2 add access_id 65 ip vlan_id 4031 tcp dst_port 138 port all deny
config access_profile profile_id 2 add access_id 70 ip vlan_id 4031 tcp dst_port 139 port all deny
config access_profile profile_id 2 add access_id 75 ip vlan_id 4031 tcp dst_port 445 port all deny
config access_profile profile_id 2 add access_id 80 ip vlan_id 4031 tcp dst_port 1900 port all deny
...
config access_profile profile_id 3 add access_id 50 ip vlan_id 4031 udp dst_port 42 port all deny
config access_profile profile_id 3 add access_id 55 ip vlan_id 4031 udp dst_port 135 port all deny
config access_profile profile_id 3 add access_id 60 ip vlan_id 4031 udp dst_port 136 port all deny
config access_profile profile_id 3 add access_id 65 ip vlan_id 4031 udp dst_port 137 port all deny
config access_profile profile_id 3 add access_id 70 ip vlan_id 4031 udp dst_port 138 port all deny
config access_profile profile_id 3 add access_id 75 ip vlan_id 4031 udp dst_port 139 port all deny
config access_profile profile_id 3 add access_id 80 ip vlan_id 4031 udp dst_port 1900 port all deny
config access_profile profile_id 3 add access_id 85 ip vlan_id 4031 udp dst_port 5355 port all deny
config access_profile profile_id 3 add access_id 90 ip vlan_id 4031 destination_ip 224.0.0.0 mask 255.0.0.0 port all deny
...
config access_profile profile_id 3 add access_id 200 ip vlan_id 4030 udp dst_port 68 port all deny
config access_profile profile_id 3 add access_id 205 ip vlan_id 4031 udp dst_port 68 port all deny
config access_profile profile_id 3 add access_id 210 ip vlan_id 3115 udp dst_port 68 port all deny
...
config access_profile profile_id 4 add access_id 20 ethernet vlan_id 3115 port all deny
config access_profile profile_id 4 add access_id 30 ethernet vlan_id 4030 port all deny
