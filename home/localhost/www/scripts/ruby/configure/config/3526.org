...
config vlan 78 add tagged 25-26
...
config vlan 904 add tagged 25-26
create vlan 3104 tag 3104
config vlan 3104 add tagged 25-26
create vlan 4008 tag 4008
config vlan 4008 add tagged 25-26
create vlan 4009 tag 4009
config vlan 4009 add tagged 25-26
config vlan 4009 add untagged 1-24
disable gvrp
config gvrp 1-24 state disable ingress_checking enable acceptable_frame admit_all pvid 4009
config gvrp 25-26 state disable ingress_checking enable acceptable_frame admit_all pvid 1

# IP

config ipif System vlan 104 ipaddress 10.52.15.94/26 state enable
disable autoconfig
...
create iproute default 10.52.15.65 1

# STORM

config traffic control_trap none
config traffic control 1-3 broadcast enable multicast enable unicast disable action drop threshold 128
config traffic control 4-5 broadcast enable multicast enable unicast disable action drop threshold 4096
...
config snmp system_location 13 liniya 6/1
...
config lldp ports 25-26 mgt_addr ipv4 10.52.15.94 enable
