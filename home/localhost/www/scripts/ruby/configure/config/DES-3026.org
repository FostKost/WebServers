...
config ipif System vlan <system vlan> ipaddress <ip>/<mask> state enable clear_description
enable telnet 23
disable web
disable autoconfig
...
config traffic control <client port> broadcast enable multicast enable action drop threshold 128 time_interval 5 countdown 5
config traffic control <system port> broadcast enable multicast enable action drop threshold 4096 time_interval 5 countdown 5
