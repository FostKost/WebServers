...
config traffic control <client port> broadcast enable multicast enable unicast disable action drop threshold 512 countdown 5 time_interval 5
...
config traffic_segmentation 1-10 forward_list <system port>
config traffic_segmentation <system port> forward_list all
