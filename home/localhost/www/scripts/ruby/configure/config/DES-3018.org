...
config ipif System vlan <system vlan> ipaddress <address>/<mask> state enable clear_description
enable telnet 23
disable web
disable autoconfig
...
config traffic_segmentation <up> forward_list 1-18
config traffic_segmentation 1-18 forward_list <up>
...
config snmp system_name <serial>
