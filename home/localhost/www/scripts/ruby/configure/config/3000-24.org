...
config vlan 134 add tagged 23-24
create vlan 234 tag 234
config vlan 234 add tagged 23-24
create vlan 934 tag 934
config vlan 934 add tagged 23-24
create vlan 3134 tag 3134
config vlan 3134 add tagged 23-24
create vlan 4074 tag 4074
config vlan 4074 add tagged 23-24
create vlan 4075 tag 4075
config vlan 4075 add tagged 23-24
config vlan 4075 add untagged 1-22
disable gvrp
disable vlan_trunk

# IP

config ipif System ipaddress 10.52.155.8/26 vlan 134 state enable
...
create iproute default 10.52.155.1 1

# STORM

config traffic control 23-24 broadcast enable multicast enable unicast disable action drop threshold 4096
config traffic control 1-22 broadcast enable multicast enable unicast disable action drop threshold 128
...
config bandwidth_control 1-24 tx_rate 102400 rx_rate 102400
...
config traffic_segmentation 1-24 forward_list 23-24
...
create trusted_host network 10.52.155.0/24 snmp telnet ssh http https ping
...
config snmp system_location Tkacheva 91 p4
...
config lldp ports 23-24 mgt_addr ipv4 10.52.155.8 enable
...
config access_profile profile_id 2 add access_id 45 ip vlan_id 4075 tcp dst_port 42 port all deny
config access_profile profile_id 2 add access_id 50 ip vlan_id 4075 tcp dst_port 135 port all deny
config access_profile profile_id 2 add access_id 55 ip vlan_id 4075 tcp dst_port 136 port all deny
config access_profile profile_id 2 add access_id 60 ip vlan_id 4075 tcp dst_port 137 port all deny
config access_profile profile_id 2 add access_id 65 ip vlan_id 4075 tcp dst_port 138 port all deny
config access_profile profile_id 2 add access_id 70 ip vlan_id 4075 tcp dst_port 139 port all deny
config access_profile profile_id 2 add access_id 75 ip vlan_id 4075 tcp dst_port 445 port all deny
config access_profile profile_id 2 add access_id 80 ip vlan_id 4075 tcp dst_port 1900 port all deny
...
config access_profile profile_id 3 add access_id 50 ip vlan_id 4075 udp dst_port 42 port all deny
config access_profile profile_id 3 add access_id 55 ip vlan_id 4075 udp dst_port 135 port all deny
config access_profile profile_id 3 add access_id 60 ip vlan_id 4075 udp dst_port 136 port all deny
config access_profile profile_id 3 add access_id 65 ip vlan_id 4075 udp dst_port 137 port all deny
config access_profile profile_id 3 add access_id 70 ip vlan_id 4075 udp dst_port 138 port all deny
config access_profile profile_id 3 add access_id 75 ip vlan_id 4075 udp dst_port 139 port all deny
config access_profile profile_id 3 add access_id 80 ip vlan_id 4075 udp dst_port 1900 port all deny
config access_profile profile_id 3 add access_id 85 ip vlan_id 4075 udp dst_port 5355 port all deny
config access_profile profile_id 3 add access_id 90 ip vlan_id 4075 destination_ip 224.0.0.0 mask 255.0.0.0 port all deny
...
config access_profile profile_id 3 add access_id 200 ip vlan_id 4074 udp dst_port 68 port all deny
config access_profile profile_id 3 add access_id 205 ip vlan_id 4075 udp dst_port 68 port all deny
config access_profile profile_id 3 add access_id 210 ip vlan_id 3134 udp dst_port 68 port all deny
...
config access_profile profile_id 4 add access_id 20 ethernet vlan_id 3134 port all deny
config access_profile profile_id 4 add access_id 30 ethernet vlan_id 4074 port all deny
