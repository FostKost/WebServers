...
config vlan default add untagged 27
create vlan 76 tag 76
config vlan 76 add tagged 1-2,21-24
create vlan 167 tag 167
config vlan 167 add tagged 1-2,21-24
create vlan 267 tag 267
config vlan 267 add tagged 1-2,21-24
create vlan 967 tag 967
config vlan 967 add tagged 1-2,21-24
create vlan 3167 tag 3167
config vlan 3167 add tagged 1-2,21-24
create vlan 3962 tag 3962
config vlan 3962 add tagged 1-2,21-24
create vlan 3963 tag 3963
config vlan 3963 add tagged 1-2,21-24
disable qinq
disable gvrp
disable vlan_trunk
config gvrp  1-2,21-24 state disable ingress_checking enable acceptable_frame admit_all pvid 1

# IP

config ipif_mac_mapping ipif System mac_offset 0
config ipif System ipaddress 10.52.211.2/24 vlan 167
...
create iproute default 10.52.211.1 1 primary
...
config traffic control 1-2,21-24 broadcast enable multicast enable unicast disable action drop threshold 4096 countdown 0 time_interval 5
config traffic control 3-20 broadcast enable multicast enable unicast disable action drop threshold 128 countdown 0 time_interval 5
...
create trusted_host network 10.52.211.0/255.255.255.0
...
config snmp system_location Vysotnaya 2
enable rmon 
...
config traffic_segmentation 1-20 forward_list 21-26
config traffic_segmentation 21-26 forward_list 1-26
...
config lldp ports 1-2,21-26 admin_status tx_and_rx
config lldp ports 3-20,27 admin_status rx_only
config lldp ports 1-26 mgt_addr ipv4 10.52.211.2 enable
