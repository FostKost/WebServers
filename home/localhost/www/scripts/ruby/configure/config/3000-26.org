...
config vlan default add tagged 1,25-26
create vlan 79 tag 79
config vlan 79 add tagged 1,25-26
create vlan 132 tag 132
config vlan 132 add tagged 1,25-26
create vlan 232 tag 232
config vlan 232 add tagged 1,25-26
create vlan 932 tag 932
config vlan 932 add tagged 1,25-26
create vlan 3132 tag 3132
config vlan 3132 add tagged 1,25-26
create vlan 4070 tag 4070
config vlan 4070 add tagged 1,25-26
create vlan 4071 tag 4071
config vlan 4071 add tagged 1,25-26
config vlan 4071 add untagged 2-24 advertisement disable
disable gvrp
disable vlan_trunk

# IP

config ipif System ipaddress 10.52.173.158/26 vlan 132 state enable
...
create iproute default 10.52.173.129 1

# STORM

config traffic control 1,25-26 broadcast enable multicast enable unicast disable action drop threshold 4096
config traffic control 2-24 broadcast enable multicast enable unicast disable action drop threshold 128
...
config bandwidth_control 1-26 tx_rate 102400 rx_rate 102400
config bandwidth_control 1,25-26 tx_rate no_limit rx_rate no_limit
...
config 802.1p default_priority 1,25-26 0
...
config traffic_segmentation 1-26 forward_list 1
config traffic_segmentation 1 forward_list all
...
config port_security ports 1,25-26 admin_state disable max_learning_addr 1 lock_address_mode deleteontimeout

# LOOP_DETECT

enable loopdetect
config loopdetect ports 1-26 state enable
config loopdetect ports 1,25-26 state disable
...
create trusted_host network 10.52.173.0/24 snmp telnet ssh http https ping
...
config snmp system_location Belyaevskaya 15 p7
...
config lldp ports 1,25-26 admin_status tx_and_rx
config lldp ports 1,25-26 mgt_addr ipv4 10.52.173.158 enable
...
config access_profile profile_id 2 add access_id 45 ip vlan_id 4071 tcp dst_port 42 port all deny
config access_profile profile_id 2 add access_id 50 ip vlan_id 4071 tcp dst_port 135 port all deny
config access_profile profile_id 2 add access_id 55 ip vlan_id 4071 tcp dst_port 136 port all deny
config access_profile profile_id 2 add access_id 60 ip vlan_id 4071 tcp dst_port 137 port all deny
config access_profile profile_id 2 add access_id 65 ip vlan_id 4071 tcp dst_port 138 port all deny
config access_profile profile_id 2 add access_id 70 ip vlan_id 4071 tcp dst_port 139 port all deny
config access_profile profile_id 2 add access_id 75 ip vlan_id 4071 tcp dst_port 445 port all deny
config access_profile profile_id 2 add access_id 80 ip vlan_id 4071 tcp dst_port 1900 port all deny
...
config access_profile profile_id 3 add access_id 50 ip vlan_id 4071 udp dst_port 42 port all deny
config access_profile profile_id 3 add access_id 55 ip vlan_id 4071 udp dst_port 135 port all deny
config access_profile profile_id 3 add access_id 60 ip vlan_id 4071 udp dst_port 136 port all deny
config access_profile profile_id 3 add access_id 65 ip vlan_id 4071 udp dst_port 137 port all deny
config access_profile profile_id 3 add access_id 70 ip vlan_id 4071 udp dst_port 138 port all deny
config access_profile profile_id 3 add access_id 75 ip vlan_id 4071 udp dst_port 139 port all deny
config access_profile profile_id 3 add access_id 80 ip vlan_id 4071 udp dst_port 1900 port all deny
config access_profile profile_id 3 add access_id 85 ip vlan_id 4071 udp dst_port 5355 port all deny
config access_profile profile_id 3 add access_id 90 ip vlan_id 4071 destination_ip 224.0.0.0 mask 255.0.0.0 port all deny
...
config access_profile profile_id 3 add access_id 200 ip vlan_id 4070 udp dst_port 68 port all deny
config access_profile profile_id 3 add access_id 205 ip vlan_id 4071 udp dst_port 68 port all deny
config access_profile profile_id 3 add access_id 210 ip vlan_id 3132 udp dst_port 68 port all deny
...
config access_profile profile_id 4 add access_id 20 ethernet vlan_id 3132 port all deny
config access_profile profile_id 4 add access_id 30 ethernet vlan_id 4070 port all deny
config access_profile profile_id 3 add access_id auto_assign ip source_ip 92.50.143.178 mask 255.255.255.255 port all permit priority 7 replace_priority 
config access_profile profile_id 3 add access_id auto_assign ip destination_ip 92.50.143.178 mask 255.255.255.255 port all permit priority 7 replace_priority 
...
# ERPS
 ...
 create erps raps_vlan 526
 config erps raps_vlan 526 timer holdoff_time 0 guard_time 500 wtr_time 5 
 config erps raps_vlan 526 rpl_port none 
 config erps raps_vlan 526 rpl_owner disable 
 config erps raps_vlan 526 ring_mel 1 
 config erps raps_vlan 526 revertive mode enable 
 config erps raps_vlan 526 ring_port west 26
 config erps raps_vlan 526 ring_port east 25
 config erps raps_vlan 526 protected_vlan add vlanid 1-525
 config erps raps_vlan 526 protected_vlan add vlanid 527-4094
 config erps raps_vlan 526 state enable
 enable erps
...
disable jumbo_frame
config ports 1-26 state enable
config ports 1-26 speed auto
config ports 1-26 flow_control disable
...
create syslog host 2 ipaddress 10.0.5.132 severity emergency facility local0 udp_port 514 state enable 
...
create authen server_host 10.0.5.132 protocol radius port 1812 key "8kJuk45oM" timeout 5 retransmit 2
config authen server_group radius delete server_host 10.0.5.132 protocol radius
config authen server_group radius add server_host 10.0.5.132 protocol radius
...
config eee ports 1-26 state disable
...
config ddm ports 21-26 state enable shutdown none
...
config jwac ports 1-26 auth_mode host_based
config jwac ports 1-26 max_authenticating_host 50 aging_time 1440 idle_time infinite block_time 60
