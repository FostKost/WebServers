   ...
   .but11{
    ...
    <body >
       ...
       echo "</div class=\"but1\">\n";
         ...
         echo "<a class=\"btn btn-warning\"href=\"/parse/kvartaly.php?b=".$b."&e=".$e."&f=".$f."\">Абсолютный</a>";
         echo "</div class=\"but11\">\n";
         echo "<div class=\"but12\">";
         echo "<a class=\"btn btn-info \"href=\"/parse/kvartaly_o.php?b=".$b."&e=".$e."&f=".$f."\">Относительный</a>";
         echo "</div class=\"but12\">\n";
         ...
         if ($f==1){
          $st="btn btn-success";
          $query = "SELECT  `kv` , COUNT( * ) AS  `c` FROM
          `drop`WHERE `begin` BETWEEN  \"".$b."\" AND  \"".$e."\" AND
          UNIX_TIMESTAMP(end)-UNIX_TIMESTAMP(begin)>(10*60)
          GROUP BY  `kv` ORDER BY  `c` DESC;";
         }
         echo "<div class=\"but10m\">";
         echo "<a class=\"".$st."  \"href=\"/parse/kvartaly.php?b=".$b."&e=".$e."&f=".$fn."\">>10 Мин</a>";
         echo "</div class=\"but10m\">\n";
