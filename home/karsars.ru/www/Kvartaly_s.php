   ...
   .but11{
    ...
    <body >
       ...
       echo "</div class=\"but1\">\n";
         ...
         echo "<a class=\"btn btn-warning  \"href=\"/parse/kvartaly_s.php?b=".$b."&e=".$e."&f=".$f."\">По событиям</a>";
         echo "</div class=\"but13\">\n";
         ...
         echo "<a class=\"".$st."  \"href=\"/parse/kvartaly_s.php?b=".$b."&e=".$e."&f=".$fn."\">>10 Мин</a>";
         echo "</div class=\"but10m\">\n";
