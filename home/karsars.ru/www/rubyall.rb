...
def post_req(file_name)# функция для отправуи post запроса
  ...
  p st=ARGV[0]+' '+ARGV[1]#склейка началого времени из 1 и 2 аргумента
  p en=ARGV[2]+' '+ARGV[3]#склейка конечного времени из 3 и 4  аргумента
  postData = Net::HTTP.post_form(URI.parse('http://info.core.ufanet.ru/events_report/'),
  {
