<html>
   ...
   .but11{
    ...
    <body >
       ...
       echo "</div class=\"but1\">\n";
         echo "<div class=\"but1\">";
         echo "<a class=\"btn btn-success\"href=\"/parse/kvartaly.php?b=".$b."&e=".$e."&f=".$f."\">По кварталам</a>";
         echo "</div class=\"but1\">\n";
         echo "<div class=\"but2\">";
         ...
         echo "<a class=\"btn btn-info\"href=\"/parse/kvartaly.php?b=".$b."&e=".$e."&f=".$f."\">Абсолютный</a>";
         echo "</div class=\"but11\">\n";
         echo "<div class=\"but12\">";
         echo "<a class=\"btn  btn-warning\"href=\"/parse/kvartaly_o.php?b=".$b."&e=".$e."&f=".$f."\">Относительный</a>";
         echo "</div class=\"but12\">\n";
         echo "<div class=\"but13\">";
         echo "<a class=\"btn btn-info \"href=\"/parse/kvartaly_s.php?b=".$b."&e=".$e."&f=".$f."\">По событиям</a>";
         echo "</div class=\"but13\">\n";

         if ($f==0){
          $st="btn";
          $query = "select `dr`.`kv`,`dr`.`c`/cou.c as c from
...
ORDER BY  `c` DESC;";
 ...
 ORDER BY  `c` DESC;";
         ...
         echo "<a class=\"".$st."  \"href=\"/parse/kvartaly_o.php?b=".$b."&e=".$e."&f=".$fn."\">>10 Мин</a>";
         echo "</div class=\"but10m\">\n";
